...
COMMANDS: dict[str, tuple[str, str, str]] = {
    ...
    "extract":      ("extract.pipeline",  "main", "Run the extraction pipeline (claude/codex CLI or API)"),
    "vault":        ("serve.vault",       "main", "Sync knowledge with the Obsidian vault (md files)"),
